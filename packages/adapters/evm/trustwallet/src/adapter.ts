...
export const TrustWalletEvmAdapterName = 'Trust Wallet' as AdapterName<'Trust Wallet'>;

export class TrustWalletEvmAdapter extends Adapter {
    name = TrustWalletEvmAdapterName;
...
export const TrustEvmAdapter = TrustWalletEvmAdapter;
export const TrustEvmAdapterName = TrustWalletEvmAdapterName;
