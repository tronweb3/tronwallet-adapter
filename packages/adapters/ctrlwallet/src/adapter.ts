...
import {
    ...
    type TronLinkMessageEvent,
    type ReqestAccountsResponse,
    type Tron,
    type NetworkChangedEventData,
    type TronAccountsChangedCallback,
    type TronChainChangedCallback,
    type TronLinkWallet,
    supportTron,
...
export class CtrlWalletAdapter extends Adapter {
    ...
    constructor(config: CtrlWalletConfig = {}) {
        super();
        const { checkTimeout = 30 * 1000, openUrlWhenWalletNotFound = true, openTronLinkAppOnMobile = true } = config;
